...
export const Profile: FC<Props> = ({
  ...
  return (
    <div className="w-[25vw] text-[#505965]">
      <div className="border-y h-[calc(100vh-73px)] overflow-auto no-scrollbar">
        <div>
          <img alt="pictures" src={pictures[0]} />
      ...
      <div className="  min-h-[73px] flex">
        <button className="border-r  bg-gray-100 w-1/2 min-h-full flex items-center justify-center hover:bg-gradient-to-r from-[#fd267a]  to-[#ff6036] hover:text-white  ">
          УДАЛИТЬ ИЗ ПАР
        </button>
        <button className="bg-gray-100 w-1/2 min-h-full flex items-center justify-center  hover:bg-gradient-to-r from-[#fd267a]  to-[#ff6036] hover:text-white">
          ЗАЯВИТЬ
        </button>
      </div>
    </div>
